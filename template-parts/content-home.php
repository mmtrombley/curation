		...
		<div class="l-constrained--desktop-wide text-center bgwrap__container">
			<div class="l-constrained">
				<div class="l-split l-padding-tx l-padding-bm border--right border-accent">				
					...
					<p class="l-padding-hm text-accent">We know our growers. This direct relationship to the people and places that cultivate our food enables us to monitor and ensure the quality of our products from field to fork.</p>
				...
				<div class="l-split l-padding-tx l-padding-bm">
					...
					<p class="l-padding-hm text-accent">Every brand in the Curation Foods portfolio meets or exceeds our strict standards of excellence and integrity for clean food ingredients. Selectivity is our namesake, after all.</p>
